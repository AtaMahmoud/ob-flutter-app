...
class CurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (colors != null) {
      ...
      bkgColorList.addAll([
        ColorConstants.CONTROL_ARC_BKG_START,
        ColorConstants.CONTROL_ARC_BKG_END
      ]);
    }
    ...
    if (slicedCurve) {
      ...
      double toAngle = startAngle + angleSlice;
      double partialSlice =
          (calcualteAngle - startAngle) - (sliceCount.floor() * angleSlice);
      for (var i = 1; i <= sliceCount; i++) {
        canvas.drawArc(
      ...
      canvas.drawArc(new Rect.fromCircle(center: center, radius: radius),
          degreeToRadians(startAngle), degreeToRadians(angle), false, paint);
    }
