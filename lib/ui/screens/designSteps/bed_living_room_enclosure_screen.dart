...
class _BedroomLivingroomEnclosureScreenState
  ...
  Widget build(BuildContext context) {
    ...
    if (designDataProvider.oceanBuilder.bedAndLivingRoomEnclousure != null) {
      _bloc.sink
          .add(designDataProvider.oceanBuilder.bedAndLivingRoomEnclousure);
  ...
  Appbar _appBar() {
    return Appbar(
      ScreenTitle.BEDROOM_PLUS_LIVING_ROOM_ENCLOSURE,
      isDesignScreen: true,
    );
  }
