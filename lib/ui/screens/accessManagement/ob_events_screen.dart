...
class _OBEventScreenState extends State<OBEventScreen> {
          ...
          children: <Widget>[
            CustomScrollView(
              slivers: <Widget>[
                ...
                len > 0
                    ? _eventList(notificationList, len)
                    : _noEventFoundText(),
  ...
  SliverList _eventList(List<ServerNotification> notificationList, int len) {
    return SliverList(
        ...
        return InkWell(
          ...
          child: Container(
            ...
            decoration: UIHelper.customDecoration(
                2, 12, ColorConstants.TOP_CLIPPER_END.withOpacity(.4),
            ...
            child: ListTile(
              ...
              title: Text(notiMsg, style: TextStyle(color: Colors.white)),
              trailing: Icon(
