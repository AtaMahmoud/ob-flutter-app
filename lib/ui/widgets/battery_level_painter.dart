...
class BatteryLevelPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final RRect batteryOutline = RRect.fromLTRBR(0.0, 0.0, batteryRight, size.height, Radius.circular(radius));
    ...
    // Battery nub
    canvas.drawRect(
      Rect.fromLTWH(batteryRight, (size.height / 2.0) - size.height/4, size.width/10, size.height/2),
    ...
    canvas.drawRRect(
      RRect.fromLTRBR(0.5, 0.5, batteryRight - 0.5, size.height - 0.5, Radius.circular(radius)),
