...
class UserOceanBuilder{
  ...
  UserOceanBuilder({this.oceanBuilderId,this.oceanBuilderName,this.userType,this.accessTime,this.reqStatus,this.checkInDate});

  factory UserOceanBuilder.fromJson(Map<String, dynamic> json) => _$UserOceanBuilderFromJson(json);

  Map<String, dynamic> toJson() => _$UserOceanBuilderToJson(this);

  static Duration _fromJson(int hours) => hours == null ? null :Duration(hours: hours);
