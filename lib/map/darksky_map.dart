...
void main() => runApp(MaterialApp(home: WebViewDarksky()));
...
class WebViewDarksky extends StatefulWidget {
  static const routeName = '/darksky_map';
  @override
  _WebViewDarkskyState createState() => _WebViewDarkskyState();
}

class _WebViewDarkskyState extends State<WebViewDarksky> {
  ...
  Widget build(BuildContext context) {
    UIHelper.setStatusBarColor(color: Colors.grey[800]);
    return Scaffold(
      // appBar: AppBar(
      //   title: const Text('Radar Map'),
      //   backgroundColor: ColorConstants.TOP_CLIPPER_END_DARK,
